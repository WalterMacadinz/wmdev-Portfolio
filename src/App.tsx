...
import fetchMonitors1 from './data/projects/project-2'
import fetchMonitors2 from './data/projects/project-3'
...
export default function App() {
	...
	return (
		<div ref={ref} className="App">
			...
			<Infosection black left={width > 1000} {...fetchMonitors1} />
			<Toolbox noPaddingTop {...fetchMonitors1.toolbox} />
			<Infosection black left={width > 1000} {...fetchMonitors2} />
			<Toolbox noPaddingTop {...fetchMonitors2.toolbox} />
			<Infosection black left={width > 1000} {...etherealUi} />
